...
void RakNet::seedMT( unsigned int seed )   // Defined in cokus_c.c
{
	//
...
unsigned int RakNet::reloadMT( void )
{
...
unsigned int RakNet::randomMT( void )
{
	unsigned int y;
