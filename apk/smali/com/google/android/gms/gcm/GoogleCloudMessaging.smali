...
.field static Up:Lcom/google/android/gms/gcm/GoogleCloudMessaging;


# instance fields
.field private Uq:Landroid/app/PendingIntent;

.field final Ur:Ljava/util/concurrent/BlockingQueue;
...
.field private Us:Landroid/os/Handler;

.field private Ut:Landroid/os/Messenger;

.field private kM:Landroid/content/Context;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Ur:Ljava/util/concurrent/BlockingQueue;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Us:Landroid/os/Handler;

    new-instance v0, Landroid/os/Messenger;

    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Us:Landroid/os/Handler;

    invoke-direct {v0, v1}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Ut:Landroid/os/Messenger;
...
.method private a(Ljava/lang/String;Ljava/lang/String;JILandroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->kM:Landroid/content/Context;
...
.method private varargs c([Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Ut:Landroid/os/Messenger;
    ...
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->kM:Landroid/content/Context;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    :try_start_0
    sget-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Up:Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    sput-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Up:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

    sget-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Up:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

    iput-object p0, v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->kM:Landroid/content/Context;
...
.method private iJ()V
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Ur:Ljava/util/concurrent/BlockingQueue;

    invoke-interface {v1}, Ljava/util/concurrent/BlockingQueue;->clear()V

    const-string v1, "google.messenger"

    iget-object v2, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Ut:Landroid/os/Messenger;
...
.method public close()V
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->iK()V
...
.method declared-synchronized h(Landroid/content/Intent;)V
    .locals 4

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Uq:Landroid/app/PendingIntent;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Uq:Landroid/app/PendingIntent;

    :cond_0
    const-string v0, "app"

    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Uq:Landroid/app/PendingIntent;
...
.method declared-synchronized iK()V
    .locals 1
...
.method public varargs register([Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->Ur:Ljava/util/concurrent/BlockingQueue;
...
.method public unregister()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->iJ()V
