...
.method public static zza(Ljava/security/interfaces/ECPrivateKey;Ljava/security/spec/ECPoint;)[B
    ...
    invoke-direct {v2, v12, v7}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    :cond_5
    invoke-virtual {v8, v1}, Ljava/math/BigInteger;->testBit(I)Z
    ...
    invoke-virtual {v9, v0, v8}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {v10, v3, v8}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {v8, v4}, Ljava/math/BigInteger;->isProbablePrime(I)Z
    ...
    invoke-virtual {v11, v5}, Ljava/math/BigInteger;->testBit(I)Z
