...
#include <Luna/Game/Packets/Class.hh>
...
void CSpawnScreen::RequestCurrentClass() {
    ...
    CLuna::Instance->Client->Send(data, RakNet::DEFAULT_PRIORITY, RakNet::RELIABLE_SEQUENCED);
}
...
void CClassManager::Install() {
    CLuna::Instance->Client->RegisterHandlerForRPC(Packets::CRequestClassResponse::PACKET_ID, {ProcessClassRequestResponse, this});
    CLuna::Instance->Client->RegisterHandlerForRPC(Packets::CRequestSpawn::PACKET_ID, {ProcessRequestSpawnResponse, this});

    CLuna::Instance->ClassManager = this;
}
...
void CClassManager::ConfirmSpawn() {
    ...
    CLuna::Instance->Client->Send(data, RakNet::HIGH_PRIORITY, RakNet::RELIABLE_SEQUENCED);
}
