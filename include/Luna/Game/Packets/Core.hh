...
struct CFootSync final : public Serde::ISerialisable, Serde::IDeserialisable {
    ...
    GameSA::CQuaternion Rotation;
    float Health;
    float Armour;
    GameSA::CVector Velocity;
    uint16_t AnimationID;
    uint16_t AnimationFlags;
    uint16_t SurfingID;
    GameSA::CVector SurfingOffset;
};
...
inline void CFootSync::Serialise(Serde::ISerialiser& serialiser) const {
...
inline void CFootSync::Deserialise(Serde::IDeserialiser& deserialiser) {
