...
#define RwIm2DVertexSetEmissiveColor(vert, color)   ((vert)->emissiveColor = (color))
#define RwIm2DVertexGetEmissiveColor(vert)          ((vert)->emissiveColor)
...
struct RwGlobals
{
        ...
        /* Current entities */
        struct RwCamera      *curCamera;             /* Current camera */
